////////////////////////////////////////////////////////////////////////////////
/////                 JS Extension for the Spec Style Sheet
/////
/////    This code handles:
...
(function() {
  ...
  /* Dark mode selector */
  const darkCSS = document.querySelector('link[rel~="stylesheet"][href^="https://www.readtech.org/CSS/dark"]');
  if (darkCSS) {
    ...
    render.innerHTML = `
      <a id="toc-theme-toggle" role="radiogroup" aria-label="Select a color scheme">
        <span aria-hidden="true"><img src="https://www.readtech.org/IMG/dark.svg" title="theme select icon" /></span>
        <span>
  ...
  if (document.location.hostname === "www.readtech.org" && /^\/ARG\//.test(document.location.pathname)) {
    ...
    (function() {
      var u="https://www.readtech.org/CTR/"; // analytics
